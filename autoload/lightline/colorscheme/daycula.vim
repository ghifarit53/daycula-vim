...
" Filename: autoload/lightline/colorscheme/daycula.vim
" Author: M. Ghifari Taqiuddin
" License: MIT License
" =============================================================================
...
let g:lightline#colorscheme#daycula#palette = lightline#colorscheme#flatten(s:p)
